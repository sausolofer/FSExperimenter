function result = runEvaluations(outputFile, algorithm, numOfFeaturesACCrankingEvaluation, resultsPath)
...
scriptEVA_sup(outputFile, algorithm,numOfFeaturesACCrankingEvaluation,resultsPath);
