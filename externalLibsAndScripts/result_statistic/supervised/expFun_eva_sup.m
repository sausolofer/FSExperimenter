function [eva] = expFun_eva_sup(filePath, filename, numOfFeaturesACCrankingEvaluation)
% function [acc] = expFun(filePath, filename)
%   filePath - the path of the data
%   filename - the name of the file

%numF = 5:5:numOfFeaturesACCrankingEvaluation;
%numF = 5:5:200;
%numF = 5:5:1000;
numF = 2:1:4;
...
for it = 1:iter
    ...
    %knnRes{it} = evalFSClasKnn(X, Y, trainIDX, testIDX, featIDX, numF);
