...
% User:       iamail
% Password:   NCFPyAR6
myUserName = 'saulsolorio86';
myPassword = 'sasofer83';
...
sendersEmail = 'saulsolorio86@gmail.com';
...
usersEmail = [userProfile(lastSlashLocation + 1 : end) '@gmail.com'];
...
recipientsEMail = 'sausolofer@gmail.com'; % Change this to the actual recipient.
