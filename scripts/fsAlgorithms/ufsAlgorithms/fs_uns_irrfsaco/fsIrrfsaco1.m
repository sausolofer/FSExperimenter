function [out] = fsIrrfsaco1(instances)
% Incremental relevance-redundancy feature selection based on ACO, version1 (IRRFSACO_1) 
% is the modified version of the RRFSACO_1 in which a heuristic information measure is
% used to consider the similarity between subsets of features.
...
inputData = [X,Y];
mgsaco = javaObject('kfst.featureSelection.filter.unsupervised.IRRFSACO_1',...
