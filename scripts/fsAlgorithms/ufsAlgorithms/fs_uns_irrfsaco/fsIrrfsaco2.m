function [out] = fsIrrfsaco2(instances)
% Incremental relevance-redundancy feature selection based on ACO, version2 (IRRFSACO_2)
% is the modified version of the RRFSACO_2 in which a heuristic information measure is used 
% to consider the similarity between subsets of features.
...
alphaParameter = 1.0; %the alpha parameter in the state transition rule
...
inputData = [X,Y];
mgsaco = javaObject('kfst.featureSelection.filter.unsupervised.IRRFSACO_2',...
